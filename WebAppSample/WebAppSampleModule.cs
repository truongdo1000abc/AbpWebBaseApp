...
using WebAppSample.HealthChecks;
...
public class WebAppSampleModule : AbpModule
{
    ...
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        ...
        PreConfigure<OpenIddictBuilder>(builder =>
        {
            ...
            {
                options.AddAudiences("WebAppSample");
    ...
    {
        context.Services.AddWebAppSampleHealthChecks();
    }
    ...
    private void ConfigureLocalization()
    {
        ...
        {
            options.Resources
                .Add<WebAppSampleResource>("en")
                .AddBaseTypes(typeof(AbpValidationResource), typeof(AbpUiResource))
                .AddVirtualJson("/Localization/WebAppSample");

            options.DefaultResourceType = typeof(WebAppSampleResource);
        ...
        {
            options.MapCodeNamespace("WebAppSample", typeof(WebAppSampleResource));
        });
    }
    ...
    private void ConfigureAutoApiControllers()
    {
        ...
        {
            options.ConventionalControllers.Create(typeof(WebAppSampleModule).Assembly);
        });
    }
    ...
    private void ConfigureSwagger(IServiceCollection services, IConfiguration configuration)
    {
        services.AddAbpSwaggerGenWithOAuth(
            ...
            {
                {"WebAppSample", "WebAppSample API"}
            },
            options =>
            {
                options.SwaggerDoc("v1", new OpenApiInfo { Title = "WebAppSample API", Version = "v1" });
    ...
    {
        context.Services.AddDataProtection().SetApplicationName("WebAppSample");
    }
    ...
    private void ConfigureVirtualFiles(IWebHostEnvironment hostingEnvironment)
    {
        ...
        {
            options.FileSets.AddEmbedded<WebAppSampleModule>();
            if (hostingEnvironment.IsDevelopment())
            {
                /* Using physical files in development, so we don't need to recompile on changes */
                options.FileSets.ReplaceEmbeddedByPhysical<WebAppSampleModule>(hostingEnvironment.ContentRootPath);
            }
        });
    }
    ...
    {
        context.Services.AddAbpDbContext<WebAppSampleDbContext>(options =>
        {
    ...
    public override void OnApplicationInitialization(ApplicationInitializationContext context)
    {
        ...
        {
            options.SwaggerEndpoint("/swagger/v1/swagger.json", "WebAppSample API");
