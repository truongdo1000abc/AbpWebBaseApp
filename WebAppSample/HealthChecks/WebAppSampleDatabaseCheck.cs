...
public class WebAppSampleDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public WebAppSampleDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
