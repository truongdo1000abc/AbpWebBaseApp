...
public class OpenIddictDataSeedContributor : OpenIddictDataSeedContributorBase, IDataSeedContributor, ITransientDependency
{
    ...
    private async Task CreateScopesAsync()
    {
        ...
        {
            Name = "WebAppSample", 
            DisplayName = "WebAppSample API", 
            Resources = { "WebAppSample" }
        });
    }
    ...
    private async Task CreateApplicationsAsync()
    {
        ...
        // Angular Client
        var consoleAndAngularClientId = configurationSection["WebAppSample_App:ClientId"];
        if (!consoleAndAngularClientId.IsNullOrWhiteSpace())
        {
            var webClientRootUrl = configurationSection["WebAppSample_App:RootUrl"]?.TrimEnd('/');
        ...
        // Swagger Client
        var swaggerClientId = configurationSection["WebAppSample_Swagger:ClientId"];
        if (!swaggerClientId.IsNullOrWhiteSpace())
        {
            var swaggerRootUrl = configurationSection["WebAppSample_Swagger:RootUrl"].TrimEnd('/');
