...
* Check the `ConnectionStrings` in `appsettings.json` file under the `WebAppSample` project and change it if you need.
...
* `WebAppSample`: ASP.NET Core API host application.
* `WebAppSample.Tests`: Test project for the application.
...
> `99c7649d-ec25-4d02-96cd-44b0030513b1` is the password of the certificate, you can change it to any password you want.
